=== Add Custom Scripts ===
Contributors: brianstunnert
Tags: add scripts, custom scripts, custom, scripts, javascript, google, analytics, google analytics, header, footer
...
Use this simple Plugin to add custom Scripts (like Google Analytics and others) to your own WordPress site or blog without any hassles.

== Description ==

Add Custom Scripts is an easy-to-use WordPress Plugin to add custom scripts (like Google Analytics) to your website's header and/or footer.  Great for Administrators who don't want to store their custom scripts in a theme's options.  These fields will remain even if the theme is changed.
...
Install Add Custom Scripts just as you would any other WP Plugin:

1.  [Download Add Custom Scripts](http://wordpress.org/plugins/add-custom-scripts/ "Download Add Custom Scripts") from WordPress.org.

2.  Unzip the .zip file.

3.  Upload the Plugin folder (add-custom-scripts/) to the wp-content/plugins folder.

4. Go to [Plugins Admin Panel](http://codex.wordpress.org/Administration_Panels#Plugins "Plugins Admin Panel") and find the newly uploaded Plugin, "Add Custom Scripts" in the list.
...
Remember, don't include the &lt;script&gt;&lt;/script&gt; tags.  They're already printed into the page by Add Custom Scripts.
...
This is most likely an issue with the javascript, not the plugin.  Ensure you have closed all of your brackets and parentheses and used semicolons where appropriate.  Keep in mind that the easiest way to get your site back online is to delete the javascript you've entered into the Add Custom Scripts textareas.
...
1. The Add Custom Scripts Administration Screen
